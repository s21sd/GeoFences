...
//            checkPermissions();
    ...
    private void checkPermissionsQ() {
        if (!Roam.checkLocationPermission()) {
            Roam.requestLocationPermission(this);
        } else if (Roam.checkBackgroundLocationPermission() == null || !Roam.checkBackgroundLocationPermission()) {
...
//        Roam.stopTracking();
    ...
    private void trackingStatus() {
        Boolean isLocationTracking = Roam.isLocationTracking();
        if (isLocationTracking != null && isLocationTracking) {
            ...
            case R.id.ckForeground:
                if (isChecked) {
                    Roam.setForegroundNotification(true,"Roam Example","Click here to redirect the app",
                            R.drawable.ic_geospark,"com.mobile.geofences.ui.SelfTrackingActivity","com.mobile.geofences.ui.service.ForegroundService");
                } else {
